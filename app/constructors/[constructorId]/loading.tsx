    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="rounded-2xl shadow-lg p-6 md:p-8 mb-8 bg-gray-50">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          <div className="flex-shrink-0 w-32 h-32 md:w-40 md:h-40 rounded-xl bg-gray-200 animate-pulse" />
          <div className="flex-grow space-y-4 w-full">
            <div className="h-16 bg-gray-200 rounded w-2/3 mx-auto md:mx-0 animate-pulse" />
